...
class IF_4D_getter():
    ...
    def __init__(self):
        ...
        self.__workload_combinations = list(combinations_with_replacement(self.__workload_list, 4))
        self.__sem = threading.Semaphore(4)
    ...
    def get_4d_IF(self):
        for workload_combination in self.__workload_combinations:
            ...
            t4 = threading.Thread(target=self.__request_workload, args=([workload_combination[3]['workload_name']]))
